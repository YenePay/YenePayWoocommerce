...
return array(
	...
	'image_url' => array(
		'title'       => __( 'Image url', 'woo_yenepay' ),
		'type'        => 'text',
		'description' => __( 'Optionally enter the URL to a 150x50px image displayed as your logo in the upper left corner of the YenePay checkout pages.', 'woo_yenepay' ),
		'default'     => '',
		'desc_tip'    => true,
